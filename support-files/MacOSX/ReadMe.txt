...
2.11. Installing MySQL on Mac OS X
   ...
   To actually install the MySQL PKG file, double-click the package
...
(Press Control-D or enter "exit" to exit the shell)
   ...
   passwords for them using the instructions in Section 2.18,
...
References
   ...
   1. file://localhost/data0/users/mysqldoc/docs-build/mysqldoc/refman-5.0/macosx-installation-nolink.html#legalnotice
